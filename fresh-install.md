...
| 5. System tweaks | `vm.swappiness=100` (zram pairing), `GRUB_TIMEOUT=5` + `update-grub`, ext4 reserved blocks → 1% (auto-detects root device), ZRAM swap (`zstd`, 100% RAM, idempotent) |
